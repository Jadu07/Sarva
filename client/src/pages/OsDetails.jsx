  ...
  if (error || !os) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] bg-white">
        ...
        <Link
          to="/explore"
          className="text-xs font-black tracking-[0.2em] uppercase text-zinc-500 hover:text-zinc-900 border-b border-zinc-900 pb-1 flex items-center gap-2"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 border-t border-zinc-200 pt-12">
          <div className="lg:col-span-2">
            ...
            <div className="mb-12">
              ...
              <p className="text-lg text-zinc-600 font-medium leading-relaxed">{os.description}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="border border-zinc-200 p-6 hover:border-zinc-500 transition-colors cursor-default">
                ...
                <h3 className="text-sm font-black uppercase text-zinc-900 mb-2 mt-auto">
                  Open & Verified
                </h3>
                <p className="text-xs text-zinc-500 font-medium">
                  All downloads link strictly to official, un-modified repositories for complete
                  security.
                </p>
              </div>
              <div className="border border-zinc-200 p-6 hover:border-zinc-500 transition-colors cursor-default">
                ...
                <p className="text-xs text-zinc-500 font-medium">
                  Get the latest and most stable builds suited for modern workflows.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="border border-zinc-200 p-8 bg-zinc-50 relative overflow-hidden group">
              ...
              <div className="space-y-6 relative z-10">
                <div>
                  ...
                  <p className="font-mono text-lg font-medium text-zinc-900 inline-block px-2 py-0.5 bg-zinc-200">
                    {os.version}
                  </p>
                </div>
